"""Rosquist and Jantzen Bianchi VI tilted γ-law perfect fluid solution.

This is a homogeneous solution with vorticity, see section 3.4 of 2211.08133.
"""
...
def data(t, x, y, z):
    """Return dictionary of Roquist Jantzen data."""
