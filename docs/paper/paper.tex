...
simulations, with helper functions provided to read in data from
standard NR codes. Given the increasing use of NR, \texttt{aurel} offers
a timely post-processing tool to support the popularisation of this
field.
...
the fly, during simulations. To study the outputs, provided by
\texttt{Carpet}, there are Python reading packages available
...
(Eulerian, Lagrangian, or conserved); NR formulations; constraints;
