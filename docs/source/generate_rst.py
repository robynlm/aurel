...
with open(output_file, "w") as f:
    ...
    f.write("************\n\n")
    allfunctions = []
    for name, func in inspect.getmembers(au.AurelCore, inspect.isfunction):
